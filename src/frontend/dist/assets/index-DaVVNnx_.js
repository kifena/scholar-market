...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", "data-ocid": "footer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-semibold text-foreground tracking-tight", children: [
      "Scholar",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-light", children: "Mkt" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-wrap items-center gap-6", children: links2.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-body font-lighter text-muted-foreground text-center md:text-right", children: [
      "© ",
      year,
      ".",
      " ",
...
function HeroSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      "data-ocid": "hero",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-px rule-gold" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl w-full mx-auto text-center flex flex-col items-center gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-hero-muted font-body font-lighter", children: "The Academic Research Marketplace" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display leading-none tracking-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: "finally has a market."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 rule-gold" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-2xl text-base md:text-lg leading-relaxed font-body font-lighter text-hero-muted", children: "Students sell original academic papers. Publishers license unique research from top universities and transform it — via minimally-invasive AI — into newsletters, articles, posts, short-form content, or video scripts." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-4 mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-px rule-gold" })
      ]
    }
  );
}
...
function NavBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      "data-ocid": "nav",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-6xl mx-auto px-6 h-16 flex items-center justify-between", children: [
            ...
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  "aria-hidden": "true",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: menuOpen ? "Close menu" : "Open menu" }),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card border-t border-border px-6 py-4 flex flex-col gap-4", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollTo(l.href),
...
const steps = [
  {
    ...
    description: "Papers are pushed to you based on your publication's niche and topic — no sifting through irrelevant work."
  },
  {
    id: "license",
    label: "License with one click",
    description: "Purchase the rights to a student's research. Transparent pricing, clear terms, no negotiation."
  },
  {
    id: "transform",
    label: "Transform via AI",
    description: "Our minimally-invasive AI adapts the research into whichever format you need — preserving academic integrity."
  }
];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.22em] text-muted-foreground font-body font-lighter mb-6", children: "For Publishers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-lighter text-[clamp(1.6rem,4vw,2.8rem)] leading-snug text-foreground max-w-3xl mb-3", children: [
          "Gain immediate access to",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "already completed" }),
          ", unique research by students from top universities."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body font-lighter text-muted-foreground text-base mb-4 max-w-xl", children: "Transform it into any format you need with our minimally-invasive AI." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rule-gold w-16 mb-12" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-10", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-medium text-foreground text-base mb-1", children: s.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body font-lighter text-sm text-muted-foreground leading-relaxed", children: s.description })
            ] })
          ] }, s.id)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-muted-foreground font-body font-lighter mb-5", children: "Output formats" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: formats.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 p-6 border border-gold/30 bg-muted/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-lighter text-sm text-foreground leading-relaxed", children: '"The same research that earned a student a grade now powers your next publication — curated, licensed, and ready to publish."' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xs text-muted-foreground font-body font-lighter tracking-wide uppercase", children: "ScholarMkt Editorial" })
            ] })
          ] })
        ] })
      ] })
...
const benefits = [
  {
    ...
    description: "Submit your completed research with relevant keywords and tags. Any discipline, any institution."
  },
  {
    id: "curation",
    label: "Expert curation",
    description: "Our editorial team reviews every submission for originality and academic merit before it reaches publishers."
  },
  {
    id: "discovery",
    label: "Publishers discover you",
    description: "Your work is matched to publishers based on niche and topic — no cold outreach, no agents."
  },
  {
    id: "earn",
    label: "Earn on every license",
    description: "Receive payment each time a publisher licenses your research. Your intellectual labor finally has a price tag."
  }
];
function StudentSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.22em] text-muted-foreground font-body font-lighter mb-6", children: "For Students" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-lighter text-[clamp(1.6rem,4vw,2.8rem)] leading-snug text-foreground max-w-3xl mb-4", children: [
          "Finally get recognized ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "& paid" }),
          " ",
          "for all the intellectual labor you've done for free in school."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rule-gold w-16 mb-12" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-x-16 gap-y-10", children: benefits.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-medium text-foreground text-base mb-1", children: b.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body font-lighter text-sm text-muted-foreground leading-relaxed", children: b.description })
          ] })
        ] }, b.id)) })
      ] })
    }
...
function WaitlistForm() {
  ...
  const [userType, setUserType] = reactExports.useState("student");
  ...
  if (status === "success") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto text-center flex flex-col items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rule-gold w-16" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "We'll be in touch as soon as ScholarMkt opens its doors. Keep doing great work."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rule-gold w-16" })
        ] })
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "oklch(0.68 0.022 56.72)" },
            children: "Be among the first students and publishers to access the marketplace when we launch."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rule-gold w-16 mb-10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: ["student", "publisher"].map((type) => {
                  const active = userType === type;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex-1 cursor-pointer", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "radio",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          borderColor: active ? "oklch(0.72 0.082 56.72)" : "oklch(0.35 0.010 56.72)",
                          color: active ? "oklch(0.72 0.082 56.72)" : "oklch(0.55 0.015 56.72)",
                          background: active ? "oklch(0.72 0.082 56.72 / 0.08)" : "transparent"
                        },
                        children: type
                      }
                    )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: status === "loading" ? "Submitting…" : "Request Early Access"
                }
              )
            ]
          }
...
function LandingPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StudentSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PublisherSection, {}),
